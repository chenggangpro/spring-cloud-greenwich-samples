package pro.chenggang.project.greenwich.feign.support;
...
public class MockMultipartFile implements MultipartFile {
     ...
     * @throws IOException if reading from the stream failed
     */
    public MockMultipartFile(String name, String originalFilename,InputStream contentStream) throws IOException {
